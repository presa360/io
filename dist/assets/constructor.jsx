...
const DEF_BRAND = { name: 'Presa', logo: null, logoRatio: null, accent: null, pageNum: true };
...
function ConstructorApp() {
  ...
  const addSlideFromTpl = (t) => {
    ...
    showToast('Слайд добавлен', `${Lib.categoryLabel(t.category)} · ${t.name}`);
  };
  ...
  return h('div', { className: 'cx' },
    ...
    view === 'wizard' ? h(window.PresaWizard, { onComplete: onWizardComplete, onExit: () => { window.location.href = 'index.html'; } }) :
