...
(function () {
  ...
  function Icon({ name, color, size, stroke }) {
    ...
    const paths = set[name] || set.box || [];
    return h('svg', { width: size, height: size, viewBox: '0 0 24 24', fill: 'none', stroke: color, strokeWidth: stroke || 1.7, strokeLinecap: 'round', strokeLinejoin: 'round', style: { width: size, height: size, flex: '0 0 auto' } },
